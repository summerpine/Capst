...
class SignupYoutuberActivity:AppCompatActivity() {
    var storage : FirebaseStorage? = null
    var auth : FirebaseAuth?= null
    var firestore : FirebaseFirestore? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_signup_youtuber)
                ...
                auth!!
                    ...
                    .addOnCompleteListener(this) { task ->
                        if (task.isSuccessful) {
                            ...
                            firestore?.collection("UserInfoYoutuber")?.document()?.set(UserDTO)
                        ...
                        // task -> isFailed
                            ...
                            Toast.makeText(
                                this@SignupYoutuberActivity, "Authentication failed.",
                                Toast.LENGTH_SHORT
                            ).show()
                        } // task -> isFaield
